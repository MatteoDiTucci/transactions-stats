...
class LogTransactionControllerTest {
    ...
    private LogTransactionController logTransactionController;

    @BeforeEach
    void setup() {
        clock = Clock.fixed(BASE_INSTANT, ZoneId.of("Europe/Rome"));
        logTransaction = mock(LogTransaction.class);
        logTransactionController = new LogTransactionController(clock, logTransaction);
    }
    ...
    public void replyCreatedWhenRequestIsValid() {
        ...
        HttpResponse<String> response = logTransactionController.logTransaction(transaction);
    ...
    void callLogTransactionUseCase() {
        ...
        logTransactionController.logTransaction(transaction);
